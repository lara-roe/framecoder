...
## Installing PicAnalyzer
The most recently built `.exe` (experimental!) can be found on [AppVeyor](https://ci.appveyor.com/project/vankesteren/mobileeye/build/artifacts).
